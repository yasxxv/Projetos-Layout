// Herança
// JavaScript tem o conceito de herança como a maioria das linguagens de programação
//  orientadas a objetos. Que é criar uma nova classe que herda os atributoes e métodos de uma 
//  classe pai. A nova classe, por sua vez, é chamada de classe filha.
...
// Ele se aplica na orientação a objetos no uso de Herança e na implementação de interfaces (que 
//     não é possível em JavaScript).

// Quando fazemos herança, nossa classe passa a ter vários tipos, assim como os objetos criados 
// por ela.

// Os tipos são: O tipo da própria classe, denotado pelo mesmo nome da classe e o tipo de qualquer
//  super classe que ela herde.

// No exemplo, Cidadao é Cidadao e Pessoa.

// Veja que usamos o verbo ser aqui "Cidadao É Cidadao e É Pessoa.

// Essa é uma boa regra para validar herança inclusive, quando você não puder dizer que a sub classe É
//  a super classe, ela não será candidata para herança.

// Em linguagens dinâmicas, o polimorfismo de classes e objetos não é tão imprescindível e necessário 
// como acontece em linguagens estáticas. No entanto, você sempre poderá verificar se um objeto tem um 
// determinado tipo usando instanceof.
...
// Essa técnica é muito usada quando um objeto de determinado tipo deve ser passado por parâmetro para
//  uma função ou método por exemplo.
